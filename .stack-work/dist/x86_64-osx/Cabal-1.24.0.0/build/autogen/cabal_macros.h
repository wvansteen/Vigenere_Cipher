...
/* package vigenere-cipher-0.1.0.0 */
#define VERSION_vigenere_cipher "0.1.0.0"
#define MIN_VERSION_vigenere_cipher(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "vigenere-cipher-0.1.0.0"

#define CURRENT_PACKAGE_KEY "vigenere-cipher-0.1.0.0"
